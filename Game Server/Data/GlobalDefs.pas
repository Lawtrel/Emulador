...
type
  ...
  TCLPID = (
    ...
    CLPID_REGNICK                           = $0086,
    CLIPD_NEWCHAR                           = $0580,
    CLIPD_GET_FULL_SP_INFO                  = $01A7,
    CLIPD_CHANNEL_LIST                       = $000E,
    CLPID_SERVER_LIST                        = $009A,
    CLPID_CHAR_LIST                         = $0613,
    CLPID_NOTHING                           = $FFFF,
    CLPID_562                               = $0232
  );
  ...
  TSVPID = (
    ...
    SVPID_NEWCHAR                           = $0581,
    SVPID_GET_FULL_SP_INFO                  = $01A8,
    SVPID_SERVER_LIST                        = $009B,
    SVPID_CHANNEL_LIST                      = $000F,
    SVPID_NOTHING                           = $FFFF
  );
